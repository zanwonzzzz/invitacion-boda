...
.hero {
  ...
  width: 100%;
  height: 100vh;
  background: url('resource/foto_filtro_si_2.jpeg') center/cover no-repeat;
}
...
.celebrate {
  ...
  width: 100%;
  height: 85vh;
  background: url('resource/i_y_s.png') left -150px no-repeat;
...
.foto-mano {
  ...
  background-image: url("resource/foto_mano.png");
...
.flores-confirmation {
  ...
  background-image: url("resource/flores.png");
...
.waiting {
  ...
  background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), 
              url('resource/foto_beso.png') center/cover no-repeat;
  display: flex;
  flex-direction: column;
...
<section class="hero">
  <img src="../public/Diseño sin título.png"
       class="names"
       alt="Iram y Samantha">

  <img src="resource/14_Marzo_2026.png"
       class="date"
       alt="14 de marzo">
...
<section class="celebrate">
  <img src="resource/sobre.png" alt="Sobre" class="sobre">
  <img src="resource/foto_filtro_si_1.jpeg" alt="Foto de la pareja" class="foto">
  <img src="resource/agradecimiento.png" alt="Agradecimiento" class="agradecimiento">
  <img src="resource/versiculo.png" alt="Versículo" class="versiculo">
  <img src="resource/t_esperamos.png" alt="Te esperamos para celebrar" class="te-esperamos">
</section>

<section class="ubication">
  <img src="resource/imagen_propuesta_cortada.png" alt="Propuesta" class="foto-propuesta">
  
  <div class="ubicacion-info">
    <img src="resource/nos_casaremos_en.png" alt="Nos casaremos en" class="nos-casaremos">
    <img src="resource/NH_Quinta.png" alt="NH Quinta" class="nh-quinta">
    <div class="mapa-wrap">
...
<section class="day">
  <img src="resource/orden_del_dia.png" class="day-title-img" alt="Orden del día">

  <div class="eventos-container">
    <div class="evento">
      <img src="resource/logo_civil.png" class="evento-icon">
      <img src="resource/civil_6.png" class="evento-info">
    </div>

    <div class="evento">
      <img src="resource/logo_anillos.png" class="evento-icon">
      <img src="resource/religiosa_7.png" class="evento-info">
    </div>

    <div class="evento">
      <img src="resource/logo_copas.png" class="evento-icon">
      <img src="resource/recepcion_8.png" class="evento-info">
    </div>
  </div>

  <div class="dress-code-section">
    <img src="resource/drees_code.png" class="dress-code-img">
    <img src="resource/no_blanco.png" class="no-blanco-img">
  </div>
</section>

<section class="gifts">
  <div class="gifts-content">
    <img src="resource/mesa_regalos.png" class="mesa-regalos-title">
    <p class="selecciona-text">Selecciona:</p>

    <div class="logos-tiendas">
       <a href="https://mdr.cimaco.com.mx/evento/46495" target="_blank">
         <img src="resource/logo_cimaco.png">
       </a>
     
      <a href="https://mesaderegalos.liverpool.com.mx/milistaderegalos/51923616" target="_blank">
        <img src="resource/logo_liverpool.png">
      </a>
...
<section class="confirmation">
  <div class="confirmation-content">
    <img src="resource/queremos.png" class="queremos-title" alt="Queremos que seas parte">
    <img src="resource/confirma.png" class="confirma-text" alt="Confirma tu asistencia">
    
    <a href="URL_DE_TU_FORMULARIO" target="_blank">
      <img src="resource/boton.png" class="boton-rsvp" alt="Boton RSVP">
    </a>
  </div>
...
<section class="waiting">
  <div class="waiting-footer">
    ...
    <div class="waiting-left">
      <img src="resource/t_esperamos.png" class="te-esperamos-final" alt="Te esperamos">
    </div>

    <div class="waiting-right">
      <img src="resource/s_e.png" class="nombre-firma" alt="Samantha Estrada">
      <img src="resource/numero.png" class="contacto-img" alt="871 145 8601">
    </div>
